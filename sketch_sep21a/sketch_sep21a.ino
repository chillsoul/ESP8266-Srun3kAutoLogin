...
static const char* ssid = "路由器名";
static const char* sspw = "路由器密码";
static const char* stuno = "学号";
static const char* stupw = "校园网密码";

static const char* url = "http://172.16.154.130:69/cgi-bin/srun_portal";
char payload[150];
void setup() {
